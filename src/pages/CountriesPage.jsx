...
const CountriesPage = () => {
    ...
    .map((country, index) => <div 
    key={'c'+index}
    className="border border-black aspect-[2/1.3] hover:scale-95 cursor-pointer"
    ><img
    className="h-[100%] w-full object-cover"
    src={country.flags.svg} alt={country.flags.alt}></img></div>)
    ...
    for(let i = 0; i<numberOfPages; i++){
        ...
        <button
            className="p-2 w-12 hover:scale-110"
            key={`pg${i}`}
